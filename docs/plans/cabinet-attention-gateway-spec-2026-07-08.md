...
|---|---|---|
| **P1 Identity** | situation.py; canonical refs wired into `propose_actions` dedup, `lane_dedup`, ledger refs | Replay the 2026-07-07 corpus: the 5 testament evidence spellings collapse to one situation; ~24 observed cards → ≤8 situations; full suite green |
