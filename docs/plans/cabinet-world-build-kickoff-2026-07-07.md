...
1. **Buy LimeZu packs** (~$8: Modern Interiors + Modern Exteriors + Character Generator, limezu.itch.io) and drop them where the build session says — payment needs you.
