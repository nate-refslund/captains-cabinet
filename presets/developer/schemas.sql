-- presets/developer/schemas.sql
-- Additional database tables specific to the developer preset (byte-twin of
-- the work preset's schema — the developer preset is a flat copy of work).
