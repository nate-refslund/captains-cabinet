...
effort: max
tools: Bash, Read, Edit, Write, Glob, Grep, Agent, mcp__notion, mcp__linear, mcp__library, mcp__plugin_telegram_telegram, mcp__redis_trigger_channel, mcp__screenpipe, mcp__chrome_devtools, mcp__playwright, mcp__cua, mcp__plugin_dev-tasks_dev-tasks
color: blue
skills:
  - cabinet-task
  - org-status
...
3. **Review** — spawn an Opus review agent (fresh context, asymmetric reviewer) before committing. Fix all findings.
