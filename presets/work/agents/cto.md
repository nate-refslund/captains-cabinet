...
effort: max
tools: Bash, Read, Edit, Write, Glob, Grep, Agent, mcp__neon, mcp__vercel, mcp__linear, mcp__library, mcp__plugin_telegram_telegram, mcp__redis_trigger_channel, mcp__playwright, mcp__plugin_dev-tasks_dev-tasks
color: green
skills:
  - cabinet-task
  - org-status
