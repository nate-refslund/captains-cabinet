...
effort: max
tools: Bash, Read, Edit, Write, Glob, Grep, Agent, mcp__neon, mcp__vercel, mcp__library, mcp__plugin_telegram_telegram, mcp__redis-trigger-channel, mcp__playwright
color: green
skills:
  - cabinet-task
  - org-status
