...
Cap: 10 escalations per officer per 24h. Counter at Redis `cabinet:opus-escalations:cro:<YYYY-MM-DD>`. If you hit cap mid-session, finish current work as Sonnet and flag in your next briefing.
