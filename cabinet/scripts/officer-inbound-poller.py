...
# line. MECHANICAL for the same reason /killswitch, /score and availability are:
# a date he sets must not depend on an officer being awake to write it down —
# that is exactly how the paid case happened (a captain-set release date absent
# from twelve days of briefings). Storage is the LIBRARY's contract
