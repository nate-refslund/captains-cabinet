...
C7_ITEMS = [
    ...
    {"slug": "testamente-passport", "lane": None,
     "subject": "Bring passport for the testamente signing",
     "kind": "founder-action", "keywords": ["passport"],
     "deadline": "2026-07-10T12:00:00Z", "harm": "external_deadline"},
    {"slug": "ajour-faktura", "lane": None,
     "subject": "Betal AJOURADVOKATER-faktura (samlevertestamente, "
                "sagsnr. 30278)",
     "kind": "founder-action", "keywords": ["ajouradvokater"],
     "deadline": "2026-07-13T12:00:00Z", "harm": "value_decay"},
    {"slug": "notar-appointment", "lane": None,
     "subject": "Book notar appointment to sign samlevertestamente",
