...
print_errand_notes() {
  ...
  errand_line "  python3.12 -m framework.liveness.fleetwatch --status   # expect local+external"
  errand_line "  python3.12 -m framework.liveness.fleetwatch --dry-run  # expect a verdict"
  errand_line "  python3.12 cabinet/scripts/fleetwatch-install.py --install"
