...
const mockConfig: Record<string, unknown> = {
  ...
  linear: {
    team_key: 'TEAM',
    workspace_url: 'https://linear.app/your-team',
  },
  telegram: {
    officers: {
      cos: 'cabinet_cos_bot',
...
const mockProjectConfig: Record<string, unknown> = {
  ...
  notion: {
    cabinet_hq_id: 'your-notion-page-id',
    dashboard: {
      page_id: 'your-dashboard-page-id',
      decision_queue_db: 'your-decision-queue-db-id',
      daily_briefings_db: 'your-daily-briefings-db-id',
      weekly_reports_db: 'your-weekly-reports-db-id',
    },
    business_brain: {
      page_id: 'your-business-brain-page-id',
    },
    research_hub: {
      page_id: 'your-research-hub-page-id',
    },
    product_hub: {
      page_id: 'your-product-hub-page-id',
    },
    engineering_hub: {
      page_id: 'your-engineering-hub-page-id',
    },
    cabinet_ops: {
      page_id: 'your-cabinet-ops-page-id',
    },
    reference: {
      page_id: 'your-reference-page-id',
    },
    archive: {
      page_id: 'your-archive-page-id',
    },
  },
  linear: {
    team_key: 'TEAM',
