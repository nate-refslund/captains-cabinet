...
def _act_first_gates_ok(action_type, board, kind, *,
    ...
    ``posture`` threads to the cap peek (D11 — None is byte-identical; sovereign
    alarms at the base cap and blocks only at the ×hard_multiplier hard-stop)."""
    try:
